...
<head>
	...
	<title>Iglesia Wesleyana Casa de Dios</title>
...
<body>
	...
	<!--AQUI INICIA LA CABECERA Y MENU DE NAVEGACION-->	
	<header>
		<nav>
			<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
			  <a class="navbar-brand" href="#">
			  	<img src="assets/img/iconos/Logogris.png" alt="" width="350" class="img-fluid ml-md-4 ml-lg-4 ml-xl-4">
			  </a>
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    <ul class="navbar-nav ml-auto font-weight-bold">
			      ...
			      <li class="nav-item dropdown">
			        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ESCUELAS</a>
			        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
			          <a class="dropdown-item" href="#">CONSOLIDACIÓN</a>
			          <a class="dropdown-item" href="#">DISCIPULADO</a>
	...
	<!--AQUI TERMINA CABECERA Y MENU DE NAVEGACION-->
		...
		<div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
		  ...
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img class="d-block w-100" src="assets/img/carrusel/slide1.png" alt="First slide">
		      <div class="carousel-caption d-none d-md-block">
				    <h5>Lorem ipsum dolor.</h5>
				    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, similique.</p>
				  </div>
		    </div>
		    <div class="carousel-item">
		      <img class="d-block w-100" src="assets/img/carrusel/slide2.png" alt="Second slide">
		      <div class="carousel-caption d-none d-md-block">
				    <h5>Lorem ipsum dolor.</h5>
				    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, similique.</p>
				  </div>
		    ...
		    <div class="carousel-item">
		      <img class="d-block w-100" src="assets/img/carrusel/slide3.png" alt="Third slide">
		      <div class="carousel-caption d-none d-md-block">
				    <h5>Lorem ipsum dolor.</h5>
				    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, similique.</p>
				  </div>
			...
			<div class="row">
				<div class="col-12 col-ms-12 col-md-8 col-lg-8 col-xl-8">
					<div class="embed-responsive embed-responsive-16by9">
  					<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/OceNj5XHywA" allowfullscreen></iframe>
					</div>
				</div>
